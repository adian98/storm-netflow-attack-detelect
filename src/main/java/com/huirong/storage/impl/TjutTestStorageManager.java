 ...
 * 2015年12月13日
 */
public class TjutTestStorageManager implements StorageManager{

	public final static String LOAD_BLACKLIST = "select ip from tjut_black_list"; 
	public final static String ADD_BACKWARD_SESSION_RECORD = 
			"insert into tjut_unidirectional_backward_session_record(start_time, end_time, duration, protocol, srcIp, srcPort,"
	...
	public final static String ADD_FORWARD_SESSION_RECORD =
			"insert into tjut_unidirectional_forward_session_record(start_time, end_time, duration, protocol, srcIp, srcPort,"
			+ "dstIp, dstPort, packets, bytes, bps, bpp, pps, insert_time) values ";
	public final static String ADD_DDOS_METRICS = "insert into tjut_realtime_ddos_metrics(time_window, record_creation_num, ntp_num, "
	...
	public final static String ADD_ATTACK_EVENTS = "insert into tjut_attack_event(date, srcIp, srcPort, dstIp, dstPort, protocal, "
	...
	public void addBlacklistIpSession(List<BlacklistIpSession> ls) {
		...
		try {
			Connection conn = DBConnector.getConn();
			Statement statement = conn.createStatement();
			sb.append("insert into tjut_blacklist_ip_session(ip, m_date, duration, protocol, srcIp, srcPort, dstIp, dstPort,"
