...
import com.huirong.biz.impl.SessionTracker;
 ...
 * 2015年12月12日
 */
public class SessionTrackerBolt implements IRichBolt{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6806354597714338221L;
	...
	public void prepare(Map arg0, TopologyContext arg1, OutputCollector arg2) {
		try {
			...
			// 添加需要执行的业务逻辑
			biz.add(new SessionTracker());
			
			for(BusinessLogic bl : this.biz){
				bl.prepare(arg0, dataSource, storageManager, 
						Arrays.asList(NetflowParserBolt.TIME_FRAME_FIELD,
								NetflowParserBolt.OBJ_FIELD ,
								NetflowParserBolt.FLOW_KEY));
			}
